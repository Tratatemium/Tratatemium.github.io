      ...
      <div className={styles.wraper}>
        ...
        <section className={styles.text}>
          <p>
            ...
            Hyper Island, Stockholm Sweden. Originally from Moscow, I've lived
            in Sweden since 2022 and I'm building a new career in tech after
            working in logistics and warehouse management.
          </p>
          <p>
